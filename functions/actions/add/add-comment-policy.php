...
// Add a comment policy box after the comments.
	...
	<div class="comment-policy-box">
		<p class="comment-policy">
			<small>
				...
				Please, only use your real name and limit the amount of links submitted in your comment.
				We accept clean XHTML in comments, but don't overdo it please.
			</small>
		</p>
	</div>
	<?php
